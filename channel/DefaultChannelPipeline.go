...
func (this *TailHandler) Write(ctx ChannelHandlerContext, e interface{}) (ret interface{}) {
	return e
}

func (this *TailHandler) Close(ctx ChannelHandlerContext) {
}

func (this *TailHandler) ExceptionCaught(ctx ChannelHandlerContext, err error) {
}

type HeadHandler struct {
}

func (this *HeadHandler) MessageReceived(ctx ChannelHandlerContext, e interface{}) (ret interface{}, goonNext bool) {
	return e, true
}

func (this *HeadHandler) ChannelActive(ctx ChannelHandlerContext) (goonNext bool) {
	return true
}

func (this *HeadHandler) ChannelInactive(ctx ChannelHandlerContext) (goonNext bool) {
	return true
}

func (this *HeadHandler) ExceptionCaught(ctx ChannelHandlerContext, err error) {
}
