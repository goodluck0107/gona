...
func (t *DemoService) Test1(chlCtx channel.ChannelHandlerContext, p *TestParam1, attr channel.IAttr) error {
	logger.Info("Test1")
	return nil
}
func (t *DemoService) Test2(chlCtx channel.ChannelHandlerContext, p *TestParam2, attr channel.IAttr) error {
	logger.Info("Test2")
	return nil
}
